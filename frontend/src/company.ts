...
export const COMPANY = {
  ...
  pais: "Estados Unidos",
  // Identificador fiscal / registro (CAMBIAR)
  registro: "EIN: 00-0000000",
  // Emails de contacto (CAMBIAR)
  emailSoporte: "soporte@turno.app",
  emailLegal: "legal@turno.app",
  emailPrivacidad: "privacidad@turno.app",
