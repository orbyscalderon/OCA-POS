...
function TerminosES() {
  return (
    <>
      ...
      <h3>3. Cuentas</h3>
      <p>Eres responsable de mantener la confidencialidad de tu cuenta. Los negocios son responsables de la veracidad de sus datos, productos, servicios y disponibilidad.</p>
      <h3>4. Pagos</h3>
...
function TerminosEN() {
  return (
    <>
      ...
      <h3>3. Accounts</h3>
      <p>You are responsible for keeping your account confidential. Businesses are responsible for the accuracy of their data, products, services and availability.</p>
      <h3>4. Payments</h3>
